<?php
	...
	class cashierController extends mainModel{
		...
		public function registrarCajaControlador(){
		    ...
		    # Comprobando numero de proveedores #
		    ...
		    # Comprobando nombre de proveeder #
			...
			if($registrar_caja->rowCount()==1){
				$alerta=[
					"tipo"=>"limpiar",
					"titulo"=>"Puesto registrada",
					"texto"=>"El puesto ".$nombre." #".$numero." se registro con exito",
					"icono"=>"success"
				];
			}else{
				$alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
					"texto"=>"No se pudo registrar el puesto, por favor intente nuevamente",
					"icono"=>"error"
				];
			}
		...
		/*----------  Controlador lista de proveedor  ----------*/
